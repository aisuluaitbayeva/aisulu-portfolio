    ...
    <div style={{ fontFamily: "'Inter', sans-serif", color: INK, background: "#FFFFFF" }}>
      ...
      <Section className="pt-20 pb-16">
        ...
        >
          ...
          над валютными продуктами для банкинга: от <Accent>конвертаций</Accent> до <Accent>международных переводов</Accent>.
                ...
                <p className="text-[15px] leading-[1.65] mb-5" style={{ color: MUTED }}>
                  ...
                  {i === 1 && (
                    <>
                      ...
                      <strong className="font-medium">Разделила перегруженную одностраничную форму</strong> на последовательные шаги,{" "}
                      <strong className="font-medium">интегрировала новые требования</strong> стандарта и {" "}
                      <strong className="font-medium">добавила больше прозрачности в процесс</strong>, включая уведомления о нерабочих днях и подсказки о ближайшей доступной дате перевода
                    </>
                  )}
                  {i === 2 && (
                    <>
                      Спроектировала <strong className="font-medium">новый сценарий массового подписания договоров</strong> в B2B-платформе электронного документооборота для случаев, когда инициатор не знает данные контрагентов заранее. Вместе с командой провела usability-тестирования и создала флоу, в котором компания делится QR-кодом или ссылкой на типовой договор, а контрагент самостоятельно заполняет свои данные и подписывает документ. Сценарий также стал{" "}
                      <strong className="font-medium">дополнительной точкой входа в продукт</strong> для новых пользователей
                    </>
                  )}
                </p>
